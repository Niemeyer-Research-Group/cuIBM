...
% %geuss seidel
% while flag
%     a0 = ((q(1)     -a1*x(1)  - a2*y(1) - a3*x(1)*y(1))        );%* alpha + (1-alpha)*a0;
%     a1 = ((q(2) -a0         - a2*y(2) - a3*x(2)*y(2))/x(2)     );%* alpha + (1-alpha)*a1;
%     a2 = ((q(3) -a0 - a1*x(3)         - a3*x(3)*y(3))/y(3)     );%* alpha + (1-alpha)*a2;
%     a3 = ((q(4) -a0 - a1*x(4) - a2*y(4)           )/(y(4)*x(4)));%* alpha + (1-alpha)*a3;
% 
